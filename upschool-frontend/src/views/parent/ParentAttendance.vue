							...
							<v-card>
								...
								<v-card-text>
									<v-container>
										<v-row>
											<v-col cols="12" sm="6" md="12">
												<v-text-field label="Title of Event" :value="selectedItem.title" outlined required></v-text-field>
											</v-col>
											...
											<v-col cols="12" sm="6" md="6">
												...
												>
													...
													<v-date-picker v-model="dateStart" scrollable>
														...
														<v-btn text color="primary" @click="$refs.dialogDateStart.save(dateStart)">OK</v-btn>
													</v-date-picker>
												</v-dialog>
											</v-col>
											<v-col cols="11" sm="6">
	...
	methods: {
		...
		removeFilter(item) {
			this.selectedProperties.splice(
				this.selectedProperties.indexOf(item),
				1
			);
