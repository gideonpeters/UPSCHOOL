    ...
    <v-container>
      <v-row>
        <v-col cols="12" md="3" sm="6">
          <metric-card title="Number of Room Types" :value="items.length" />
        </v-col>
        <v-col cols="12" md="12">
          <div class="d-flex justify-end">
            <v-btn depressed color="primary" @click="dialog = true">CREATE ROOM TYPE</v-btn>
          </div>
                  ...
                  <v-container>
                    <v-row>
                      <v-col cols="12" sm="6" md="12">
                        <v-text-field outlined label="Name*" v-model="typeName" typeName required></v-text-field>
                      </v-col>
                      <v-col cols="12">
                        <v-text-field
                          outlined
